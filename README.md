...
![landing / Home page image](/static/images/landing.png)
...
- Post detail
    - From the home page or profile page the user can click on a post / video of his choice.
...
![Profile image](/static/images/profile.png)
 ...
 - pagination
    - This application has infinity scrolling, which engages the user to keep looking the application for new posts(Trully neat if you ask me)
